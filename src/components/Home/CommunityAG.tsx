...
const communityAndAG = [
...

  {
    ...
    desc: "Antennas & Propagation Society (AP-S) is a society that focuses on antenna and propagation. It is a society that is very active in the field of research and development.",
    url: "/aps",
    img: "https://img.freepik.com/free-photo/wireless-television-antenna-sign-download_1172-230.jpg",
  },
  {
    title: "Women In Engineering",
    desc: "Women IN Engineering Affinity Group (WIE) is a society. It is a society that is very active in the field of research and development.",
    url: "/wie",
